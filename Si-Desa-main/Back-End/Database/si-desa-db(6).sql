...
--
-- Host: localhost:3306
-- Generation Time: Feb 03, 2025 at 09:51 PM
...
(14, 6, 'pupuk', 'Uang Tunai', '2025-01-27 21:32:33', '2025-02-03 03:35:01', 'approved', '1738553701_WhatsApp Image 2025-02-02 at 01.09.37_765dc185.jpg', 4);
...
CREATE TABLE `bantuan_kelompok` (
  `bantuan_kelompok_id` int NOT NULL,
  `nama_bantuan` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `jenis_bantuan` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `status` enum('pending','approved','rejected','') COLLATE utf8mb4_general_ci DEFAULT 'pending',
  `foto_bukti_kelompok` varchar(255) COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(4, 6, 12, 1, '1321091111234566', '1321091111234467', 'ode andi', 'Laki-laki', '2005-03-02', 'bandung', 'petani', '1000000.00', 2, 'ode_andi_1738553533.png', '2025-01-21 06:38:47', '2025-02-03 03:32:13', '', '');
...
--
ALTER TABLE `bantuan`
  MODIFY `bantuan_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT for table `bantuan_kelompok`
--
ALTER TABLE `bantuan_kelompok`
  MODIFY `bantuan_kelompok_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT for table `batch_users`
--
ALTER TABLE `batch_users`
  MODIFY `batch_user_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
...
--
ALTER TABLE `penduduk`
  MODIFY `penduduk_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
