                ...
                <tr>
                  <tbody>
                    <tr style="height:25px;">
                        <td rowspan="7" width="250px"><img src="img/ftC5.jpg" width="250px"></td>
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            <tr onclick="redirectToDetail('detailDokumen1.html')">
                                ...
                                <td>12 Juli 2020</td>
                                <td>
                                    <button class="btn btn-primary" onclick="openPreview('doc/ijzC.pdf')">Preview</button>
                                </td>
                            </tr>
                            <tr onclick="redirectToDetail('detailDokumen2.html')">
                                ...
                                <td>25 Mei 2019</td>
                                <td>
                                    <button class="btn btn-primary" onclick="openPreview('doc/ktpC.pdf')">Preview</button>
                                </td>
                            </tr>
                        </tbody>
                    </table>
