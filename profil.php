...
<head>
    ...
    <style>
        ...
        .btn-custom:hover {
            ...
            /* Warna latar belakang putih saat hover */
            color: black;
            /* Warna teks hitam saat hover */
...
<body>
            ...
            <main>
                <div class="container mt-5">
                    <div class="row justify-content-center">
                        <div class="col-lg-8 col-md-10 col-sm-12"> <!-- Perlebar kolom -->
                                    ...
                                    <form id="formAddPendapatan" action="Back-End/proses_tambah_penduduk_user.php" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-6">
                                                <label for="kk" class="form-label text-start">KK</label>
                                        ...
                                        <div class="row">
                                            <!-- Nama Lengkap -->
                                            <div class="form-group col-md-6">
                                                <label for="nama_lengkap" class="form-label text-start">Nama Lengkap</label>
                                        ...
                                        <div class="row">
                                            <!-- Daerah -->
                                            <div class="form-group col-md-6">
                                                <label for="daerah_id" class="form-label text-start">Kampung</label>
                                            ...
                                            <!-- Agama -->
                                            <div class="form-group col-md-6">
                                                <label for="agama_id" class="form-label text-start">Agama</label>
                                                <select class="form-select" id="agama_id" name="agama_id" onchange="toggleAgamaLainnya(this)" required>
                                        ...
                                        <div class="row">
                                            ...
                                            <!-- Gaji -->
                                            <div class="form-group col-md-6">
                                                <label for="gaji" class="form-label text-start">Gaji/Bulan</label>
                                        ...
                                        <div class="row">
                                            <!-- Jumlah Keluarga -->
                                            <div class="form-group col-md-6">
                                                <label for="jumlah_keluarga" class="form-label text-start">Jumlah Anggota Keluarga</label>
                                            ...
                                            <!-- Foto Diri -->
                                            <div class="form-group col-md-6">
                                                <label for="foto_diri" class="form-label text-start">Foto Diri</label>
                                        ...
                                        <div class="row">
                                            <!-- Dokumen KK -->
                                            <div class="form-group col-md-6">
                                                <label for="file_kk" class="form-label text-start">Dokumen KK</label>
                                                <input type="file" class="form-control" name="file_kk" id="file_kk" accept=".pdf,.doc,.docx" required>
                                            </div>

                                            <!-- Dokumen KTP -->
                                            <div class="form-group col-md-6">
                                                <label for="file_nik" class="form-label text-start">Dokumen KTP</label>
    ...
    <script>
        function toggleAgamaLainnya(select) {
            var inputAgamaLainnya = document.getElementById('inputAgamaLainnya');
